...
class LodogaPrime(LodogaBase):
   ...
   def addPlatformComponents(self):
      ...
      self.syscpld.addReloadCauseProvider(causes=[
         ...
         SysCpldCause(0x20, SysCpldCause.RAIL, 'P3V3_ALW'),
         SysCpldCause(0x21, SysCpldCause.RAIL, 'P5V0_ALW'),
         SysCpldCause(0x22, SysCpldCause.RAIL, 'P1V0_CP'),
         SysCpldCause(0x23, SysCpldCause.RAIL, 'P1V2_CP'),
         SysCpldCause(0x24, SysCpldCause.RAIL, 'P1V8_CP'),
         SysCpldCause(0x25, SysCpldCause.RAIL, 'P3V3_CP'),
         SysCpldCause(0x26, SysCpldCause.RAIL, 'P3V3'),
         SysCpldCause(0x27, SysCpldCause.RAIL, 'P0V8CORE'),
         SysCpldCause(0x28, SysCpldCause.RAIL, 'P0V8A_LEFT'),
         SysCpldCause(0x29, SysCpldCause.RAIL, 'P0V8A_RIGHT'),
         SysCpldCause(0x2a, SysCpldCause.RAIL, 'P1V2_TD'),
         SysCpldCause(0x2b, SysCpldCause.RAIL, 'P1V8'),
