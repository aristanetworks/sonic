...
def getSfpUtil():
    ...
    class SfpUtilNative(SfpUtilCommon):
        ...
        def __init__(self):
            ...
            for xcvrId, xcvr in xcvrs.items():
                self.xcvr_presence_map[xcvrId] = xcvr.getPresence()
        ...
        def get_transceiver_change_event(self, timeout=0):
            ...
            while True:
                for xcvrId, xcvr in xcvrs.items():
                    ...
                    if self.xcvr_presence_map[xcvrId] != presence:
                        ret[str(xcvrId)] = '1' if presence else '0'
                        self.xcvr_presence_map[xcvrId] = presence
